...
(require 'aibridge-ui-org)

;; UI-facing customization, faces, and prompt are now in aibridge-ui-org.el
...
;; Title overlay is defined in UI module now
;; (defvar-local aibridge-org--title-overlay nil)
(defvar-local aibridge-org--registered-cid nil)

;; Model selection UI -----------------------------------------------------
;; Model selection UI and helpers are moved to aibridge-ui-org.el

;; Model selection and title helpers moved to aibridge-ui-org.el
